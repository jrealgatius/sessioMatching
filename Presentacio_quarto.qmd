...
author: "Jordi Real <br> jrealg@santpau.cat"
institute: "Digital Health Validation Center <br> Hospital Sant Pau"
slide-number: true
smaller: true
format:
  revealjs:
    logo: "logos/Logo_dapcat_idiap_2.png"
...
-   Medida de asociación **no ajustada**: OR= 2,03 (IC95%: 1,7 - 2,5)
-   Medida de asociación **ajustada según regressión**: OR= 1,56 (IC95%: 1,21 - 2,04)[^3]
...
[^3]: Ajustado por: Edad, sexo, Población, Composición familiar, Nivel educativo, Ingresos familiarias, clase social
...
![Covariate plot](figures/density_PS_pre_post.png){.fragment width="100%" height="100%"}
...
![Esquema de selección de casos](figures/Matching_density_incidence.PNG){width="55%" height="55%"}
...
- Vemos como van apareciendo los casos durante la fase de reclutamitneo. El primer caso que aparece es la senyora Manuela en el mes 3. Aquí buscamos una señora entre todas las potenciales Controles i disponibles. 
